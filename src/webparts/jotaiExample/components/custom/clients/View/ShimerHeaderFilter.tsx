...
const ShimerHeaderFilter: React.FC = (): React.ReactElement => {
    ...
    const RenderBodyContent = React.useCallback(() => {
        ...
        return <>
            <div className="boxCard">
                <div className="formGroup" >
                    <h1 className="mainTitle" style={{ textAlign: "left" }}>Shimmer Header Filter</h1>
...
export default ShimerHeaderFilter;