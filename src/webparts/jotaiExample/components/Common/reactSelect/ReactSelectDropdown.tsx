...
import { SortArray, getUniueRecordsByColumnName } from '../../../Shared/Utils';
...
const ReactDropdown: React.FunctionComponent<IReactDropdownProps> = (props: IReactDropdownProps): React.ReactElement<IReactDropdownProps> => {
    ...
    return (
        <Select
            ...
            // value={filteredSortedOptions.filter((option: IReactDropOptionProps) => {
            //     return (isMultiSelect && defaultOption !== null) ?
            //         (defaultOption.length > 0 && defaultOption.indexOf(option?.value) >= 0)
